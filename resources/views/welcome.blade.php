...
<body>
            ...
            <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                ...
                <div class="flex items-center lg:order-2">
                    ...
                    <a href="https://themesberg.com/product/tailwind-css/landing-page"
                        class="text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-purple-600 dark:hover:bg-purple-700 focus:outline-none dark:focus:ring-purple-800">Mon
                        espace</a>
                ...
                <div class="items-center  justify-between hidden w-full lg:flex lg:w-auto lg:order-1"
                    ...
                    <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        ...
                        <li>
                            <div class="relative">
                                <button type="button"
                                    class="inline-flex items-center gap-x-1 text-sm font-semibold leading-6 text-black"
                                ...
                                <div id="dropdown-menu"
                                    class="absolute left-1/2 z-10 mt-5 flex w-screen max-w-max -translate-x-1/2 px-4 hidden">
                                    ...
                                    <div
                                        ...
                                        <div class="p-4">
                                            ...
                                            <div class="group relative flex gap-x-6 rounded-lg p-4 hover:bg-gray-50">
                                                ...
                                                <div>
                                                    <a href="#" class="font-semibold text-gray-900 mt-9">
                                                        Evènement Etudiants
                                                        <span class="absolute inset-0"></span>
                                                    </a>
    ...
    <section class="bg-gray-500 ">
        <div class="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
            <!-- Row -->
            <h1 class="text-white text-3xl font-bold">Evenement en cours</h1>
            <div class="lg:flex   ">
                <div
                    class="lg:h-48 mt-4 transition transform duration-700 hover:shadow-xl hover:scale-105 rounded-lg relative lg:ml-4 lg:w-1/4">
                    <img class="transform transition duration-300 hover:scale-105 h-48 rounded-lg"
                        src="./images/css.jpeg" alt="" />
                    <div class="py-5">
                        ...
                        <div class="flex">
                            <p class="mb-2 text-xs font-semibold text-white text-left">
                                2023.05.10 - 2023.11.30
                            </p>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-4 h-4 ml-36">
                                <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div
                    class="lg:ml-4 transition transform duration-700 mt-4 hover:shadow-xl hover:scale-105 rounded-lg relative lg:w-1/4">
                    <img class="transform transition duration-300 hover:scale-105 rounded-lg h-48"
                        src="./images/js.jpeg" alt="" />
                    <div class="py-5">
                        <p class="mb-2 text-sm flex font-semibold text-white text-left">
                            Programme de mise à jour de septembre 2023 Plus d'exposition et
                            plus de récompenses vous attendent !
                ...
                <div
                    class="lg:h-48 lg:ml-4 transition transform duration-700 hover:shadow-xl mt-4 hover:scale-105 rounded-lg relative lg:w-1/4">
                    <img class="transform transition duration-300 hover:scale-105 rounded-lg h-48"
                ...
                <div
                    class="transition transform duration-700 hover:shadow-xl mt-4 hover:scale-105 rounded-lg relative lg:ml-4 lg:w-1/4">
                    <img class="transform transition duration-300 hover:scale-105 h-48 rounded-lg"
                        src="./images/php.png" alt="" />
                    <div class="py-5">
                        <p class="mb-2 text-sm flex font-semibold text-white text-left">
                            Programme de mise à jour de septembre 2023 Plus d'exposition et
                            plus de récompenses vous attendent !
            ...
            <img class="w-full" src="./images/sports-ad_1.jpg" alt="" />
            <!-- Row -->
    ...
    <section class="bg-white dark:bg-gray-900 ">
        <div class="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
            <!-- Row -->
            <h1 class="text-white text-3xl font-bold">Événement recents</h1>
            <div class="lg:flex   ">
                <div
                    class="lg:h-48 mt-4 transition transform duration-700 hover:shadow-xl hover:scale-105 rounded-lg relative lg:ml-4 lg:w-1/4">
                    <img class="transform transition duration-300 hover:scale-105 h-48 rounded-lg"
            ...
            <!-- Row -->
            <img class="w-full" src="./images/sports-ad_2.jpg" alt="" />
        </div>
    </section>
    ...
    <section class="bg-gray-50 dark:bg-gray-800 ">
        ...
        <div class="grid gap-2 lg:grid-cols-3 mx-9 mt-4">
                ...
                <div class="flex mt-4">
                    <div class="justify-start">
                        <img class="object-cover w-20 h-20 border-2 border-green-500 rounded-full"
                            src="./images/young-3061652__340.jpg" />
                    </div>

                    <a href="#" class="text-xl font-medium text-white mt-4 text-left ml-6">John Doe <br />
                        <spam class="text-sm">Eleve Tle Scientifique</spam>
                    </a>
                </div>
            </div>
